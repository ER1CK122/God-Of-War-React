export default function TrofeuComponent(props){
  return(
    <div className='d-flex border border-dark w-75'>
      <div className='border-end border-dark p-2 d-flex align-items-center justify-content-center'><img src={props.trofeu} alt="" /></div>
      <div className='border-end border-dark w-100 ps-2 pe-2'>
